...
- HTTP status: `403`
- codes: `FORBIDDEN`, `EMAIL_NOT_VERIFIED`, `ACCOUNT_NOT_PROVISIONED`, `ACCOUNT_DISABLED`, `TASK_CREATION_FORBIDDEN`, `TASK_DELETION_FORBIDDEN`, `TASK_UPDATE_FORBIDDEN`, `TASK_ASSIGNMENT_FORBIDDEN`, `TEAM_MANAGEMENT_FORBIDDEN`, `EMPLOYEE_DASHBOARD_FORBIDDEN`, `PRODUCTIVITY_SCOPE_FORBIDDEN`, `GOAL_CREATION_FORBIDDEN`, `GOAL_UPDATE_FORBIDDEN`
- used when a user is authenticated but not allowed to access a resource

### Resource Scope Errors

- HTTP status: `404`
- codes: `TEAM_NOT_FOUND`, `TASK_NOT_FOUND`, `ASSIGNEE_NOT_FOUND`, `USER_NOT_FOUND`, `GOAL_NOT_FOUND`
...
- HTTP status: `400`
- code: `INVALID_ASSIGNEE_ROLE`, `HOURS_TASK_TEAM_MISMATCH`, `INVALID_GOAL_TARGET_ROLE`, `INVALID_GOAL_CONFIGURATION`
...
- HTTP status: `503`
- codes: `AUTH_CONFIGURATION_MISSING`, `AUTH_ADMIN_CONFIGURATION_MISSING`, `AUTH_EMAIL_CONFIRMATION_NOT_ENABLED`
...
- `AUTH_EMAIL_CONFIRMATION_NOT_ENABLED`
