...
- HTTP status: `403`
- codes: `FORBIDDEN`, `ACCOUNT_NOT_PROVISIONED`, `ACCOUNT_DISABLED`, `TASK_CREATION_FORBIDDEN`, `TASK_DELETION_FORBIDDEN`, `TASK_UPDATE_FORBIDDEN`, `TASK_ASSIGNMENT_FORBIDDEN`, `TEAM_MANAGEMENT_FORBIDDEN`, `EMPLOYEE_DASHBOARD_FORBIDDEN`, `PRODUCTIVITY_SCOPE_FORBIDDEN`, `GOAL_CREATION_FORBIDDEN`, `GOAL_UPDATE_FORBIDDEN`
